...
console.log(exclaimThree("today is monday"));
...
console.log(bestMovie("Spy Kids 3"));
...
const sampleStringFunc = (sampleString) =>
...
const emailCheck = (email) => {
  let emailModified = "" + email.trim();
  return emailModified.includes("@")
    ? "email verified"
    : "must provide a valid email address";
};
console.log(emailCheck("   brev@glsk.com    "));
...
//CODE HERE
let totalFrogs = 0;
const yummyFrogs = (gold) => {
  totalFrogs = gold / 3;
  totalFrogs = Math.floor(totalFrogs);
  return `You can buy ${totalFrogs} yummy frogs!`;
};
console.log(yummyFrogs(12));
////////////////// PROBLEM 20 ////////////////////
/*
